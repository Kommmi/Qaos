...
def Avg_separation_QKT_GQS(dhilbert,nqubit,system_site,U_F,theta0,phi0,eps,N_traj,N_kicks,min_period=10,max_period=100,show_plot=False):
    """
    ...
    if show_plot:
        ...
        ml2, _, _ = plt.stem(range(N_kicks), ln_avg_dist_L,linefmt='#4682B4-', markerfmt='#4682B4^',basefmt=' ',label='Quantum EMD')
